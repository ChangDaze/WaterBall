...
public class Student {
    ...
    private final boolean[] availableTimeSlots; // include[早上九點到晚上十點]之間空閒的時間段
    ...
    public boolean[] getAvailableTimeSlots() { return availableTimeSlots;}
    ...
    private String availableTimeSlotsToString() {
        return range(0, availableTimeSlots.length)
                ...
                .mapToObj(i -> String.valueOf(i+9/*start with 9 AM*/))
                .collect(joining(" "));
    }
}
