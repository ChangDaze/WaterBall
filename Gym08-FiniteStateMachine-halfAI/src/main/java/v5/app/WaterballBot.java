...
public class WaterballBot extends Bot {
    ...
    private static StateMachine buildMachine(Community community, Member self) {
        ...
        recordInner.addTransition(new Transition(recording, BroadcastStoppedEvent.class, Guard.ALWAYS, Action.NONE, waiting));
        ...
        root.addTransition(new Transition(knowledgeKing, NewMessageEvent.class,
                ...
                e -> kingCtx.clear(),
                normal));
        root.addTransition(new Transition(knowledgeKing, TimeElapsedEvent.class,
