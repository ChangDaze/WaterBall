...
class CommunityTest {
    ...
    void ids_die_at_the_door_same_member_object_everywhere() {
        ...
        NewMessageEvent event = (NewMessageEvent) received.stream()
                .filter(e -> e instanceof NewMessageEvent).findFirst().orElseThrow();
    ...
    void broadcast_echo_formats() {
        ...
        assertEquals(List.of(
                "OUT 📢 4 is broadcasting...", "EVT GoBroadcastingEvent",
                "OUT 📢 4: Test", "EVT SpeakEvent",
                "OUT 📢 4 stop broadcasting", "EVT BroadcastStoppedEvent"), log);
