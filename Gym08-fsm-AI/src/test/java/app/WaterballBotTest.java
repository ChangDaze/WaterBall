...
/**
 * End-to-end behavior through the real wiring (Main.run), pinning the
 * ground-truth strings from testcases/. The golden-file harness
 * (TestcaseHarnessTest) covers the full scenarios; these tests document the
 * individual rules they rest on.
 */
class WaterballBotTest {
